...
namespace EventPlatform.WebApi.Initializers
{
            ...
            List<Tag> tags)
        {
            var events = new List<Event>
            {
                ...
                new Event
                {
                    ...
                    ModerationStatus = EventModerationStatus.UnderModeration,
                    Creator = users[1],

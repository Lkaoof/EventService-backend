...
namespace EventPlatform.Application.Interfaces.Application
{
    public interface IActions
    {
        ...
        Task<Result<T>> GetBy<T>(Expression<Func<T, object>> fieldSelector, object value, CancellationToken ct = default) where T : BaseEntity;
        Task<Result<M>> GetBy<T, M>(Expression<Func<T, object>> fieldSelector, object value, CancellationToken ct = default) where T : BaseEntity;
